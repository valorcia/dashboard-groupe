...
const SEED = {
  ...
  noeuds: [
    ...
    { id: 'cat-acquisition', parent: 'commercial', label: 'Acquisition leads', icone: '🧲', couleur: '#dc2626', type: 'categorie' },
    { id: 'cat-conversion',  parent: 'commercial', label: 'Conversion devis',  icone: '💼', couleur: '#dc2626', type: 'categorie' },

    // Actions sous Acquisition
    { id: 'jotform-wh',  parent: 'cat-acquisition', label: 'Webhook Jotform → Odoo', icone: '📝', couleur: '#dc2626', type: 'action',
    ...
    { id: 'crm-odoo',    parent: 'cat-acquisition', label: 'Brancher CRM Odoo en live', icone: '🔌', couleur: '#dc2626', type: 'action',
      objectif: 'Live data dashboard agent commercial', responsable: 'Loïc', echeance: '2026-06-15', statut: 'en_cours', priorite: 'haute', avancement: 70, societe: 'groupe', impact: 'Suivi temps réel' },

    // Actions sous Conversion
    { id: 'closing',     parent: 'cat-conversion', label: 'Coach IA closing > 30k€', icone: '🎙️', couleur: '#dc2626', type: 'action',
      objectif: 'Conversion +10pts sur gros deals',  responsable: 'À nommer', echeance: '2026-09-30', statut: 'idee', priorite: 'moyenne', avancement: 0, societe: 'groupe', impact: 'Marge sur gros deals' },
    { id: 'relance-devis', parent: 'cat-conversion', label: 'Agent relance devis auto', icone: '📨', couleur: '#dc2626', type: 'action',
      objectif: 'Relance J+7 / J+14', responsable: 'Loïc', echeance: '2026-07-15', statut: 'planifie', priorite: 'haute', avancement: 30, societe: 'groupe', impact: 'Conversion + cycle réduit' },
